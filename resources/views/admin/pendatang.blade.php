...
@section('judul','Data Pendatang')

@section('content')
    <div class="container-fluid">
        <div class="card card-default">
            <div class="card-header">{{ __('Pengelolaan Data Pendatang') }}</div>
            <div class="card-body"> 
            <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('admin.pendatang') }}">Pendatang</a>
            </li>
            <li class="nav-item">
                        ...
                        @foreach ($pendatang as $row)
                            <tr>
                                ...
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a class="btn  btn-success" href="pendatang/terima/{{$row->id}}"><i class="fa fa-check"></i></a>
                                            <button class="btn btn-xs"></button>
                                            <a class="btn  btn-warning" href="pendatang/tolak/{{$row->id}}"><i class="fa fa-times"></i></a>
                                            <button class="btn btn-xs"></button>
                                    </div>
                                ...
                                @if($row->approve == 0)
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <button type="button" id="btn-edit-jurusan" class="btn btn-xs btn-success"
                                            ...
                                            @elseif($row->approve == 1)
                                            <a class="btn  btn-warning" href="pendatang/print/{{ $row->id }}"><i class="fa fa-print"></i></a>
                                            @else
                                            @endif
                                    </div>
                                </td>
